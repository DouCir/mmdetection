...
class TwoStageDetectorMul(BaseDetectorMul, RPNTestMixin, BBoxTestMixin,
                          MaskTestMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(TwoStageDetectorMul, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(TwoStageDetectorMul, self).init_weights(pretrained)
    ...
    def simple_test(self, img, img_t, img_meta, proposals=None, rescale=False):
    ...
    def aug_test(self, imgs, imgs_t, img_metas, rescale=False):
        ...
        proposal_list = self.aug_test_rpn(
            self.extract_feats(imgs, imgs_t), img_metas, self.test_cfg.rpn)
        det_bboxes, det_labels = self.aug_test_bboxes(
            self.extract_feats(imgs, imgs_t), img_metas, proposal_list,
            self.test_cfg.rcnn)
